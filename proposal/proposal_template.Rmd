...
death_rates_total_air_pollution <- read_csv("death-rates-total-air-pollution.csv")
death_rates_from_air_pollution <- read_csv("death-rates-from-air-pollution.csv")
